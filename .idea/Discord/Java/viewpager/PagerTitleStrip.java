...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void onMeasure(int i, int i2) {
        if (MeasureSpec.getMode(i) == BasicMeasure.EXACTLY) {
            ...
            if (MeasureSpec.getMode(i2) == BasicMeasure.EXACTLY) {
                i = MeasureSpec.getSize(i2);
            } else {
                i = Math.max(getMinHeight(), this.mCurrText.getMeasuredHeight() + paddingBottom);
            }
    ...
    public void setNonPrimaryAlpha(@FloatRange(from = 0.0d, to = 1.0d) float f) {
        ...
        i = (i << 24) | (this.mTextColor & ViewCompat.MEASURED_SIZE_MASK);
