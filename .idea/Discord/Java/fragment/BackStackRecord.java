...
public final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull State state) {
        if (fragment.mFragmentManager == this.mManager) {
            ...
            if (state == State.INITIALIZED && fragment.mState > -1) {
                stringBuilder = new StringBuilder();
                stringBuilder.append(str);
                stringBuilder.append(state);
                stringBuilder.append(" after the Fragment has been created");
                ...
                stringBuilder.append(str);
                stringBuilder.append(state);
                stringBuilder.append(". Use remove() to remove the fragment from the FragmentManager and trigger its destruction.");
                throw new IllegalArgumentException(stringBuilder.toString());
            }
        }
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (i3 = i; i3 < i2; i3++) {
                    ...
                    for (int i6 = 0; i6 < size2; i6++) {
                        Fragment fragment2 = ((Op) backStackRecord.mOps.get(i6)).mFragment;
