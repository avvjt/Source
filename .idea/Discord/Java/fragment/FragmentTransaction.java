...
public abstract class FragmentTransaction {
    ...
    public static final class Op {
        public int mCmd;
        public State mCurrentMaxState;
        public int mEnterAnim;
        public int mExitAnim;
        public Fragment mFragment;
        public State mOldMaxState;
        public int mPopEnterAnim;
        public int mPopExitAnim;
        ...
        public Op(int i, @NonNull Fragment fragment, State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            ...
            if (transitionName != null) {
                if (this.mSharedElementSourceNames == null) {
                    ...
                    if (this.mSharedElementTargetNames.contains(str)) {
                        throw new IllegalArgumentException(a.u("A shared element with the target name '", str, str2));
                    } else if (this.mSharedElementSourceNames.contains(transitionName)) {
                        throw new IllegalArgumentException(a.u("A shared element with the source name '", transitionName, str2));
                    }
                }
