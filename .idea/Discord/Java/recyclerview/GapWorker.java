...
public final class GapWorker implements Runnable {
    ...
    public static Comparator<Task> sTaskComparator = new Comparator<Task>() {
        public int compare(Task task, Task task2) {
            ...
            int i = 1;
            if ((recyclerView == null ? 1 : null) != (task2.view == null ? 1 : null)) {
    ...
    private void flushTaskWithDeadline(Task task, long j) {
        ViewHolder prefetchPositionWithDeadline = prefetchPositionWithDeadline(task.view, task.position, task.immediate ? RecyclerView.FOREVER_NS : j);
