...
public class Styleable {
    @StyleableRes
    public static final int[] ARC_MOTION = new int[]{16843901, 16843902, 16843903};
    @StyleableRes
    public static final int[] CHANGE_BOUNDS = new int[]{16843983};
    @StyleableRes
    public static final int[] CHANGE_TRANSFORM = new int[]{16843964, 16843965};
    @StyleableRes
    public static final int[] FADE = new int[]{16843745};
    @StyleableRes
    public static final int[] PATTERN_PATH_MOTION = new int[]{16843978};
    @StyleableRes
    ...
    @StyleableRes
    public static final int[] TRANSITION_MANAGER = new int[]{16843741, 16843742, 16843743};
    @StyleableRes
    public static final int[] TRANSITION_SET = new int[]{16843744};
    @StyleableRes
    public static final int[] TRANSITION_TARGET = new int[]{16842799, 16843740, 16843841, 16843842, 16843853, 16843854};
    @StyleableRes
    public static final int[] VISIBILITY_TRANSITION = new int[]{16843900};
