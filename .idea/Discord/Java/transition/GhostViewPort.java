...
public class GhostViewPort extends ViewGroup implements GhostView {
        ...
        public boolean onPreDraw() {
            ...
            if (viewGroup != null) {
                ...
                if (view != null) {
                    ...
                    ghostViewPort = GhostViewPort.this;
    ...
    public static GhostViewPort addGhost(View view, ViewGroup viewGroup, Matrix matrix) {
        if (view.getParent() instanceof ViewGroup) {
            View holder = GhostViewHolder.getHolder(viewGroup);
            GhostViewPort ghostView = getGhostView(view);
            int i = 0;
            if (ghostView != null) {
                View view2 = (GhostViewHolder) ghostView.getParent();
                if (view2 != holder) {
                    i = ghostView.mReferences;
                    view2.removeView(ghostView);
                    ghostView = null;
                }
            }
            if (ghostView == null) {
