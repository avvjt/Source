...
public class Explode extends Visibility {
    ...
    private void calculateOut(View view, Rect rect, int[] iArr) {
        ...
        if (epicenter == null) {
            ...
            round2 = Math.round(view.getTranslationY()) + ((view.getHeight() / 2) + i2);
        } else {
            round = epicenter.centerX();
            round2 = epicenter.centerY();
        }
        float centerX = (float) (rect.centerX() - round);
        float centerY = (float) (rect.centerY() - round2);
        ...
        float calculateMaxDistance = calculateMaxDistance(view, round - i, round2 - i2);
    ...
    public Animator onDisappear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        calculateOut(viewGroup, rect, this.mTempLoc);
        int[] iArr2 = this.mTempLoc;
        return TranslationAnimationCreator.createAnimation(view, transitionValues, i, i2, translationX, translationY, f + ((float) iArr2[0]), f2 + ((float) iArr2[1]), sAccelerate, this);
    }
