...
public class ChangeBounds extends Transition {
    ...
    private static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, ModelAuditLogEntry.CHANGE_KEY_POSITION) {
            ...
            if (i3 > 0) {
                ...
                if (this.mResizeClip) {
                    ...
                    if (rect7.equals(rect5 == null ? new Rect(i, i, i12, i13) : rect5)) {
                        ...
                        Animator ofObject = ObjectAnimator.ofObject(view, "clipBounds", sRectEvaluator, new Object[]{rect7, r2});
