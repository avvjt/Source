...
public class TransitionManager {
    ...
    public void setTransition(@NonNull Scene scene, @NonNull Scene scene2, @Nullable Transition transition) {
        SimpleArrayMap simpleArrayMap = (ArrayMap) this.mScenePairTransitions.get(scene2);
        if (simpleArrayMap == null) {
            simpleArrayMap = new ArrayMap();
            this.mScenePairTransitions.put(scene2, simpleArrayMap);
        }
        simpleArrayMap.put(scene, transition);
    }
}
