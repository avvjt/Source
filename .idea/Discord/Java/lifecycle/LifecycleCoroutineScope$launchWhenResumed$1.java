...
public final class LifecycleCoroutineScope$launchWhenResumed$1 extends h implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invoke(Object obj, Object obj2) {
        return ((LifecycleCoroutineScope$launchWhenResumed$1) create(obj, (Continuation) obj2)).invokeSuspend(Unit.a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (PausingDispatcherKt.whenResumed(lifecycle$lifecycle_runtime_ktx_release, function2, (Continuation) this) == aVar) {
                return aVar;
            }
        } else if (i == 1) {
            g.throwOnFailure(obj);
